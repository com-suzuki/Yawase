VERSION 5.00
Begin {2AF752CD-B826-4828-B4C1-13BFC9CC90C1} rptYpmf290 
   ClientHeight    =   11010
   ClientLeft      =   -3495
   ClientTop       =   285
   ClientWidth     =   15240
   Icon            =   "rptYpmf290.dsx":0000
   StartUpPosition =   2  '画面の中央
   WindowState     =   2  '最大化
   _ExtentX        =   26882
   _ExtentY        =   19420
   SectionData     =   "rptYpmf290.dsx":000C
End
Attribute VB_Name = "rptYpmf290"
...
Private Sub Detail_Format()
    ...
    If IsDate(txtOdate.Text) = True Then
        txtNen.Text = Format(txtOdate.Text, "e")
        txtTuki.Text = Month(txtOdate.Text)
        txtHi.Text = Day(txtOdate.Text)
    Else
        txtNen.Text = ""
        txtTuki.Text = ""
        txtHi.Text = ""
