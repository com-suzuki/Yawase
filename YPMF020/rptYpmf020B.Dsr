VERSION 5.00
Begin {2AF752CD-B826-4828-B4C1-13BFC9CC90C1} rptYpmf020B 
   ClientHeight    =   11115
   ClientLeft      =   -3495
   ClientTop       =   285
   ClientWidth     =   15240
   Icon            =   "rptYpmf020B.dsx":0000
   StartUpPosition =   2  '画面の中央
   WindowState     =   2  '最大化
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "rptYpmf020B.dsx":000C
End
Attribute VB_Name = "rptYpmf020B"
...
Private Sub ActiveReport_ReportStart()
    ...
    '会社名
    Me.txtCompanyName.Text = Global_Get_CompanyName(g_clsAdoSQL)
