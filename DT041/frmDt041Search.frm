...
Begin VB.Form frmDt041Search 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmDt041Search.frx":000C
      Height          =   7395
      Left            =   120
      TabIndex        =   3
      Top             =   1020
   ...
   Begin VB.Frame Frame1 
      ...
      Begin imText6Ctl.imText txtFormal 
         ...
         _ExtentX        =   8599
         _ExtentY        =   609
         Caption         =   "frmDt041Search.frx":0021
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "ＭＳ Ｐゴシック"
            Size            =   12
            Charset         =   128
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmDt041Search.frx":008F
         Key             =   "frmDt041Search.frx":00AD
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM vw_MT060"
      Caption         =   ""
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   9
   ...
   Begin imText6Ctl.imText imtFocusFirst 
      ...
      _ExtentX        =   238
      _ExtentY        =   238
      Caption         =   "frmDt041Search.frx":00E1
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   12
         Charset         =   128
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmDt041Search.frx":014F
      Key             =   "frmDt041Search.frx":016D
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtFocusEnd 
      ...
      _ExtentX        =   238
      _ExtentY        =   238
      Caption         =   "frmDt041Search.frx":01A1
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   12
         Charset         =   128
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmDt041Search.frx":020F
      Key             =   "frmDt041Search.frx":022D
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   End
End
Attribute VB_Name = "frmDt041Search"
...
Private Sub cmdExecute_Click()
    ...
    frmDt041.txtBcode.Text = txtKey1.Text
    Call frmDt041.FieldsSet(True)
    Unload Me
...
Private Sub cmdSearch_Click()
    ...
    If Trim(txtFormal.Text) <> "" Then
        ...
        strWhere = strWhere & " Dname LIKE '%" & txtFormal.Text & "%'"
    End If
...
Private Sub Order_Data(ColIndex As Integer, intFlg As Integer)
    ...
    Select Case ColIndex
        Case 0:
            strOrder = strOrder & "Dcode"
        Case 1:
            strOrder = strOrder & "Dname"
        Case 2:
            strOrder = strOrder & "Div"
        Case 3:
            strOrder = strOrder & "DivName"
    End Select
