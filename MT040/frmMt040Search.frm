...
Begin VB.Form frmMt040Search 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmMt040Search.frx":000C
      Height          =   7395
      Left            =   120
      TabIndex        =   3
      Top             =   1020
   ...
   Begin VB.Frame Frame1 
      ...
      Begin imText6Ctl.imText txtFormal 
         ...
         _ExtentX        =   5847
         _ExtentY        =   609
         Caption         =   "frmMt040Search.frx":0021
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "ＭＳ Ｐゴシック"
            Size            =   12
            Charset         =   128
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt040Search.frx":008F
         Key             =   "frmMt040Search.frx":00AD
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM vw_MT040"
      Caption         =   ""
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   9
   ...
   Begin imText6Ctl.imText imtFocusFirst 
      ...
      _ExtentX        =   238
      _ExtentY        =   238
      Caption         =   "frmMt040Search.frx":00F1
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   12
         Charset         =   128
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt040Search.frx":015F
      Key             =   "frmMt040Search.frx":017D
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtFocusEnd 
      ...
      _ExtentX        =   238
      _ExtentY        =   238
      Caption         =   "frmMt040Search.frx":01C1
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   12
         Charset         =   128
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt040Search.frx":022F
      Key             =   "frmMt040Search.frx":024D
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   End
End
Attribute VB_Name = "frmMt040Search"
...
Private Sub cmdExecute_Click()
    ...
    frmMt040.txtTcode.Text = txtKey1.Text
    Call frmMt040.FieldsSet(True)
    Unload Me
...
Private Sub cmdSearch_Click()
    ...
    If Trim(txtFormal.Text) <> "" Then
        ...
        strWhere = strWhere & " Tname LIKE '%" & txtFormal.Text & "%'"
    End If
...
Private Sub Order_Data(ColIndex As Integer, intFlg As Integer)
    ...
    Select Case ColIndex
        Case 0:
            strOrder = strOrder & "Tcode"
        Case 1:
            strOrder = strOrder & "Tname"
    End Select
