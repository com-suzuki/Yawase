...
Begin VB.Form frmMt040 
   ...
   Begin VB.Frame fraMeisai 
      ...
      Top             =   1200
      Width           =   9975
      Begin imText6Ctl.imText txtTname 
         Height          =   345
         Left            =   1560
         TabIndex        =   2
         Top             =   180
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt040.frx":1858
         Key             =   "frmMt040.frx":1876
   ...
   Begin VB.Frame fraKey 
      ...
      Begin imText6Ctl.imText txtTcode 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt040.frx":1C32
         Key             =   "frmMt040.frx":1C50
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtFocusFirst 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt040.frx":1D02
      Key             =   "frmMt040.frx":1D20
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtFocusEnd 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt040.frx":1DD2
      Key             =   "frmMt040.frx":1DF0
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
...
Private Sub chkAutoCode_Click()
    ...
    If optSyori(0).Value = True And chkAutoCode.Value = 1 Then
         txtTcode.Text = AutoCodeSet
         If txtTcode.Enabled Then txtTcode.SetFocus
    End If
...
Private Sub cmdDataMove_Click(Index As Integer)
    ...
    With m_clsAdoRecordCtl
        Select Case Index
            ...
            Case 1:
                If Trim(txtTcode.Text) = "" Then
                    Screen.MousePointer = vbDefault
                    Exit Sub
                End If
                .KeyValue = Array(CLng(txtTcode.Text))
...
Private Sub cmdExecute_Click()
    ...
    If optSyori(0).Value = True And chkAutoCode.Value = 1 Then txtTcode.Text = AutoCodeSet
...
Private Sub cmdSearch_Click()
    ...
    Screen.MousePointer = vbHourglass
    frmMt040Search.Adodc1.ConnectionString = m_clsAdoSQL.Connection.ConnectionString
    frmMt040Search.Adodc1.Refresh
    Screen.MousePointer = vbDefault
    
    frmMt040Search.Show vbModal
...
Private Sub Form_Load()
    ...
    Me.Caption = SYSTEM_NAME & "-" & "売上形式マスタ保守"
    ...
    If chkAutoCode.Value = 1 Then txtTcode.Text = AutoCodeSet
...
Private Sub optSyori_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 4: '外部出力
            ...
            objClsExcelOut.TitleName = Array("売上形式コード", "名称")
...
Private Sub txtTcode_Change()
    ...
    If Trim(txtTcode.Text) = "" Then Exit Sub

    If txtTcode.Tag <> txtTcode.Text Then
...
Private Sub txtTcode_GotFocus()

    txtTcode.Tag = txtTcode.Text
    txtTcode.BackColor = FOCUS_STOP_COLOR
    
End Sub

Private Sub txtTcode_LostFocus()

    txtTcode.Tag = ""
    txtTcode.BackColor = FOCUS_NO_COLOR
...
Private Sub txtTcode_Validate(Cancel As Boolean)
    ...
    If Trim(txtTcode.Text) = "" Then Exit Sub
    If txtTcode.Tag = txtTcode.Text Then Exit Sub
...
Private Sub txtTname_GotFocus()

    txtTname.BackColor = FOCUS_STOP_COLOR

End Sub

Private Sub txtTname_LostFocus()

    txtTname.BackColor = FOCUS_NO_COLOR
...
Public Function FieldsSet(blnVisible As Boolean, Optional adoRecordsetArg As Variant) As Boolean
    ...
    Else
        strSQL = "{call sp_MT040;2(" & txtTcode.Text & ")}"
        adoRecordset1.Open strSQL, m_clsAdoSQL.Connection, adOpenKeyset, adLockReadOnly
    End If
    ...
    With adoRecordset1
        ...
        If blnVisible = False Then
            ...
            Exit Function
        End If
        txtTcode.Text = .Fields("Tcode")
        txtTname.Text = IIf(IsNull(.Fields("Tname")), "", Trim(.Fields("Tname")))
    End With
...
Private Function DataUpdate() As Boolean
    ...
    With adoRecordset1
        ...
        If .EOF Then .AddNew
        .Fields("Tcode") = txtTcode.Text
        .Fields("Tname") = txtTname.Text
        .Update
    End With
...
Private Function DataDelete() As Boolean
    ...
    With m_clsAdoSQL.Connection
        ...
        'データ削除
        strSQL = "{call sp_MT040;9(" & txtTcode.Text & ")}"
        .Execute strSQL
...
Private Function AutoCodeSet() As String
    ...
    With adoRecordset1
        ...
        End If
        .MoveLast
        If CLng(.Fields("Tcode")) < 99 Then
            AutoCodeSet = CLng(.Fields("Tcode")) + 1
        End If
    End With
