VERSION 5.00
Begin {2AF752CD-B826-4828-B4C1-13BFC9CC90C1} rptYpmf170 
   ClientHeight    =   11010
   ClientLeft      =   -3495
   ClientTop       =   285
   ClientWidth     =   15240
   Icon            =   "rptYpmf170.dsx":0000
   StartUpPosition =   2  '画面の中央
   WindowState     =   2  '最大化
   _ExtentX        =   26882
   _ExtentY        =   19420
   SectionData     =   "rptYpmf170.dsx":000C
End
Attribute VB_Name = "rptYpmf170"
...
Private Sub ActiveReport_ReportStart()
    ...
    Detail.Visible = frmYpmf170.optPrint(0).Value
    txtOdate.Visible = frmYpmf170.optPrint(1).Value
