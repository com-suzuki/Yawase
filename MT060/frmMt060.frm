...
Begin VB.Form frmMt060 
   ...
   Begin VB.Frame fraMeisai 
      ...
      Top             =   1200
      Width           =   9975
      Begin imText6Ctl.imText txtDname 
         Height          =   345
         Left            =   1560
         TabIndex        =   2
         Top             =   180
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt060.frx":1858
         Key             =   "frmMt060.frx":1876
   ...
   Begin VB.Frame fraKey 
      ...
      Begin VB.CommandButton cmdSearch 
         ...
         Width           =   555
      End
      Begin imText6Ctl.imText txtDcode 
         Height          =   360
         Left            =   1560
         TabIndex        =   1
         Top             =   180
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt060.frx":1C22
         Key             =   "frmMt060.frx":1C40
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtFocusFirst 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt060.frx":1CE2
      Key             =   "frmMt060.frx":1D00
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtFocusEnd 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt060.frx":1DA2
      Key             =   "frmMt060.frx":1DC0
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
...
Private Sub chkAutoCode_Click()
    ...
    If optSyori(0).Value = True And chkAutoCode.Value = 1 Then
         txtDcode.Text = AutoCodeSet
         If txtDcode.Enabled Then txtDcode.SetFocus
    End If
        ...
        Select Case Index
            ...
            Case 1:
                If Trim(txtDcode.Text) = "" Then
                    ...
                    Exit Sub
                End If
                .KeyValue = Array(CLng(txtDcode.Text))
...
Private Sub cmdExecute_Click()
    ...
    If optSyori(0).Value = True And chkAutoCode.Value = 1 Then txtDcode.Text = AutoCodeSet
...
Private Sub cmdSearch_Click()
    ...
    Screen.MousePointer = vbHourglass
    frmMt060Search.Adodc1.ConnectionString = m_clsAdoSQL.Connection.ConnectionString
    frmMt060Search.Adodc1.Refresh
    Screen.MousePointer = vbDefault
    
    frmMt060Search.Show vbModal
...
Private Sub Form_Load()
    ...
    Me.Caption = SYSTEM_NAME & "-" & "商品区分マスタ保守"
    ...
    If chkAutoCode.Value = 1 Then txtDcode.Text = AutoCodeSet
...
Private Sub optSyori_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 4: '外部出力
            ...
            objClsExcelOut.TitleName = Array("商品区分", "名称")
...
Private Sub txtDcode_Change()
    ...
    If Trim(txtDcode.Text) = "" Then Exit Sub

    If txtDcode.Tag <> txtDcode.Text Then
...
Private Sub txtDcode_GotFocus()

    txtDcode.Tag = txtDcode.Text
    txtDcode.BackColor = FOCUS_STOP_COLOR
...
Private Sub txtDcode_LostFocus()
    ...
    txtDcode.Tag = ""
    txtDcode.BackColor = FOCUS_NO_COLOR
...
Private Sub txtDcode_Validate(Cancel As Boolean)
    ...
    If Trim(txtDcode.Text) = "" Then Exit Sub
    If txtDcode.Tag = txtDcode.Text Then Exit Sub
...
Private Sub txtDname_GotFocus()
    ...
    txtDname.BackColor = FOCUS_STOP_COLOR

End Sub

Private Sub txtDname_LostFocus()

    txtDname.BackColor = FOCUS_NO_COLOR
...
Public Function FieldsSet(blnVisible As Boolean, Optional adoRecordsetArg As Variant) As Boolean
    ...
    Else
        strSQL = "{call sp_MT060;2(" & txtDcode.Text & ")}"
        adoRecordset1.Open strSQL, m_clsAdoSQL.Connection, adOpenKeyset, adLockReadOnly
    End If
    ...
    With adoRecordset1
        ...
        If blnVisible = False Then
            ...
            Exit Function
        End If
        txtDcode.Text = .Fields("Dcode")
        txtDname.Text = IIf(IsNull(.Fields("Dname")), "", Trim(.Fields("Dname")))
        If Not IsNull(.Fields("Div")) Then
            If .Fields("Div") = 0 Then
                optDiv(0).Value = True
            ElseIf .Fields("Div") = 1 Then
                optDiv(1).Value = True
            End If
        Else
            optDiv(0).Value = True
...
Private Function DataUpdate() As Boolean
    ...
    With adoRecordset1
        ...
        If .EOF Then .AddNew
        .Fields("Dcode") = txtDcode.Text
        .Fields("Dname") = txtDname.Text
        If optDiv(0).Value = True Then
            .Fields("Div") = HATIMONO_DIV_OFF
        ElseIf optDiv(1).Value = True Then
             .Fields("Div") = HATIMONO_DIV_ON
        End If
        .Update
    End With
...
Private Function DataDelete() As Boolean
    ...
    With m_clsAdoSQL.Connection
        ...
        'データ削除
        strSQL = "{call sp_MT060;9(" & txtDcode.Text & ")}"
        .Execute strSQL
...
Private Function AutoCodeSet() As String
    ...
    With adoRecordset1
        ...
        End If
        .MoveLast
        If CLng(.Fields("Dcode")) < 99 Then
            AutoCodeSet = CLng(.Fields("Dcode")) + 1
        End If
    End With
