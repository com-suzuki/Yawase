...
Begin VB.Form frmYpmf080 
   ...
   Begin imText6Ctl.imText imtFocusFirst 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmYpmf080.frx":103B
      Key             =   "frmYpmf080.frx":1059
   ...
   Begin imText6Ctl.imText imtFocusEnd 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmYpmf080.frx":110B
      Key             =   "frmYpmf080.frx":1129
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtIcode_Kana_Focus1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmYpmf080.frx":11DB
      Key             =   "frmYpmf080.frx":11F9
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
...
Private Function MakePrintWork() As Boolean
    ...
    'ワーク削除
    strSQL = "DELETE FROM WK_YPMF080"
    g_clsAdoAccess.Connection.Execute strSQL

    'ワークオープン
    strSQL = "SELECT * FROM WK_YPMF080"
    wkRecordset.Open strSQL, g_clsAdoAccess.Connection, adOpenKeyset, adLockOptimistic
    
    '買主精算データオープン
    strSQL = "{call sp_YPMF0801;1('" & Trim(lblOdate.Caption) & "'," & cboBcode(0).Text & "," & cboBcode(1).Text & ")}"
    ...
    Do While Not adoDT041.EOF
        ...
        wkRecordset.Fields("Div") = IIf(IsNull(adoDT041.Fields("Rdiv")), PAYMENT_OFF, adoDT041.Fields("Rdiv"))
        Select Case wkRecordset.Fields("Div")
            Case PAYMENT_OFF:
                wkRecordset.Fields("DivName") = "未入金"
            Case PAYMENT_ON:
                wkRecordset.Fields("DivName") = "入金済"
        End Select
        ...
        '競売明細データオープン
        strSQL = "{call sp_YPMF0802;1('" & Global_Get_NumericDay(lblOdate.Caption) & "'," & adoDT041.Fields("Bcode") & "," & adoDT041.Fields("Num") & ")}"
        ...
        '注文データオープン
        strSQL = "{call sp_YPMF0803;1('" & lblOdate.Caption & "'," & adoDT041.Fields("Bcode") & "," & adoDT041.Fields("Num") & ")}"
        adoDT011.Open strSQL, g_clsAdoSQL.Connection, adOpenKeyset, adLockReadOnly
        If adoDT011.EOF = False Then
            wkRecordset.Fields("Qty") = CCur(wkRecordset.Fields("Qty")) + CCur(adoDT011.Fields("Qty_Total"))
        End If
        adoDT011.Close
        
        wkRecordset.Fields("Price") = adoDT041.Fields("Total")
        wkRecordset.Fields("Tax") = adoDT041.Fields("Tax")
        '202308 インボイス対応 wkRecordset.Fields("Total") = CCur(wkRecordset.Fields("Price")) + CCur(wkRecordset.Fields("Tax"))
        ...
        '202308 インボイス対応
        wkRecordset.Fields("Total") = CCur(wkRecordset.Fields("Price")) + adoDT041.Fields("Keep") + adoDT041.Fields("Brate2")
