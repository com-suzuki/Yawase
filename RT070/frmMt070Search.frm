...
Begin VB.Form frmMt070Search 
   BorderStyle     =   3  '固定ﾀﾞｲｱﾛｸﾞ
   Caption         =   "得意先マスタ検索(過去分参照)"
   ClientHeight    =   9405
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   14970
   Icon            =   "frmMt070Search.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin imText6Ctl.imText txtBname 
         ...
         _ExtentX        =   7117
         _ExtentY        =   609
         Caption         =   "frmMt070Search.frx":000C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt070Search.frx":007A
         Key             =   "frmMt070Search.frx":0098
      ...
      Begin imText6Ctl.imText txtBkana 
         ...
         _ExtentX        =   7117
         _ExtentY        =   635
         Caption         =   "frmMt070Search.frx":00CC
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "ＭＳ Ｐゴシック"
            Size            =   12
            Charset         =   128
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt070Search.frx":013A
         Key             =   "frmMt070Search.frx":0158
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin imText6Ctl.imText txtTel 
         ...
         _ExtentX        =   3413
         _ExtentY        =   635
         Caption         =   "frmMt070Search.frx":018C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "ＭＳ Ｐゴシック"
            Size            =   12
            Charset         =   128
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMt070Search.frx":01FA
         Key             =   "frmMt070Search.frx":0218
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "SELECT * FROM vw_MT070"
      Caption         =   ""
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   9
   ...
   Begin imText6Ctl.imText imtFocusFirst 
      ...
      _ExtentX        =   238
      _ExtentY        =   238
      Caption         =   "frmMt070Search.frx":024C
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   12
         Charset         =   128
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt070Search.frx":02BA
      Key             =   "frmMt070Search.frx":02D8
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin imText6Ctl.imText imtFocusEnd 
      ...
      _ExtentX        =   238
      _ExtentY        =   238
      Caption         =   "frmMt070Search.frx":030C
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "ＭＳ Ｐゴシック"
         Size            =   12
         Charset         =   128
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmMt070Search.frx":037A
      Key             =   "frmMt070Search.frx":0398
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   0
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmMt070Search.frx":03CC
      Height          =   7395
      Left            =   120
      TabIndex        =   5
      Top             =   1380
   ...
   End
End
Attribute VB_Name = "frmMt070Search"
...
Private Sub cmdExecute_Click()
    ...
    frmMt070.txtBcode.Text = txtKey1.Text
    Call frmMt070.FieldsSet(True)
    Unload Me
...
Private Sub cmdSearch_Click()
    ...
    If Trim(txtBname.Text) <> "" Then
        ...
        strWhere = strWhere & " Bname LIKE '%" & txtBname.Text & "%'"
    End If
    If Trim(txtBkana.Text) <> "" Then
        If Trim(strWhere) <> "" Then strWhere = strWhere & " AND "
        strWhere = strWhere & " Bkana LIKE '%" & txtBkana.Text & "%'"
    End If
...
Private Sub Order_Data(ColIndex As Integer, intFlg As Integer)
    ...
    Select Case ColIndex
        ...
        Case 1:
            strOrder = strOrder & "Bname"
        Case 2:
            strOrder = strOrder & "Bkana"
        Case 3:
            strOrder = strOrder & "Post"
        Case 4:
            strOrder = strOrder & "Addres"
        Case 5:
            strOrder = strOrder & "Tel"
        Case 6:
            strOrder = strOrder & "Fax"
        Case 7:
            strOrder = strOrder & "Adddate"
    End Select
