VERSION 5.00
Begin {2AF752CD-B826-4828-B4C1-13BFC9CC90C1} rptYpmf140 
   ClientHeight    =   11115
   ClientLeft      =   -3495
   ClientTop       =   285
   ClientWidth     =   15240
   Icon            =   "rptYpmf140.dsx":0000
   StartUpPosition =   2  '画面の中央
   WindowState     =   2  '最大化
   _ExtentX        =   26882
   _ExtentY        =   19606
   SectionData     =   "rptYpmf140.dsx":000C
End
Attribute VB_Name = "rptYpmf140"
...
Private Sub ActiveReport_ReportStart()
    ...
    '印刷日付
    Me.PrintDay.Text = Format(Now(), "yyyy年mm月dd日")
    
    '銀行の振込み先
    Me.fldGinko.Text = frmYpmf140.m_strGinkoName
